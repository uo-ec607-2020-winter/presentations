...
![Arun Srinivasan | THE #RDATATABLEPACKAGE](dt_pic2.png)
...
![data.table syntax](whynotboth.jpg)
---
# data.table v. Tidyverse?
Since data.tables are still data.frames, just upgraded, all data.frame functionality still works on them
--
